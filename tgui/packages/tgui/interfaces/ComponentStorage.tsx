 ...
 * @file
 * @copyright 2025
 * @author TBD (https://github.com/TBD)
 * @license MIT
 */
...
export const ComponentStorageModal = () => {
  const { act, data } = useBackend<ComponentStorageData>();
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Section className="ComponentStorage">
          <Stack fill className="ComponentStorage__Stack" mb={1}>
            <div className="ComponentStorage__display">
              {/* Display 4 digits, if empty show underscores */}
              {Array.from({ length: 4 }, (_, index) => {
                const digit = pin[index];
                return (
                  <span key={index} className="ComponentStorage__digit">
                  ...
                  {Array.from({ length: 3 }, (_, subIndex) => {
                    ...
                    return (
                      <Stack.Item key={subIndex} grow>
                        <Button
                          className="ComponentStorage__button"
